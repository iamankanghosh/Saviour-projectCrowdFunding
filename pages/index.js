...
export default function Index({AllData, HealthData, EducationData,AnimalData}) {
  ...
  return (
    <HomeWrapper>
      <Head>
        <title>Saviours</title>
        <link rel="icon" href="/crowdfunding.png" />
      </Head>
        ...
        return (
          ...
          <CardImg>
            <Image 
              ...
              layout='fill' 
              src={"https://crowdfunding-ipfs-ankan-ghosh.infura-ipfs.io/ipfs/" + e.image} 
            />
          </CardImg>
          <Title>
            {e.title}
          ...
          <CardData>
            <Text><PersonIcon />  Owner</Text> 
            <Text>{e.owner.slice(0,6)}...{e.owner.slice(39)}</Text>
          </CardData>
          <CardData>
            <Text><AttachMoneyIcon />Amount</Text> 
...
const Button = styled.button`
  ...
  background-image:
  linear-gradient(180deg, #ff4ef1 0%,#a558eb 80%);
  border: none;
  cursor: pointer;
  font-family: 'Nunito';
