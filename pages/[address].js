...
export default function Detail({Data, DonationsData}) {
  ...
  useEffect(() => {
    const Request = async () => {
      ...
      fetch('https://crowdfunding-ipfs-ankan-ghosh.infura-ipfs.io/ipfs/' + Data.storyUrl)
  ...
  return (
    <>
      ...
      <LeftContainer>
        <ImageSection>
          <Image
            ...
            layout="fill"
            src={
              "https://crowdfunding-ipfs-ankan-ghosh.infura-ipfs.io/ipfs/" + Data.image
            }
          />
        </ImageSection>
        <Text>
      ...
      <RightContainer>
        ...
        <DonateSection>
          <Input value={amount} onChange={(e) => setAmount(e.target.value)} type="number" min="0.000001" placeholder="Enter Amount To Donate" />
